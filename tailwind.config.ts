  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-metal-soft': 'var(--gradient-metal-soft)',
      },
      boxShadow: {
      ...
      keyframes: {
        ...
        "beam-drift": {
          "0%, 100%": { opacity: "0.35", transform: "translateX(0) rotate(12deg)" },
          "50%": { opacity: "0.6", transform: "translateX(30px) rotate(12deg)" },
        },
      },
      animation: {
